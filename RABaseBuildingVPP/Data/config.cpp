class CfgPatches
{
	class THTerritoryHQ
	{
		units[] = {"TerritoryHQ","TerritoryHQ_Hologram","TerritoryHQ_Kit"};
		weapons[] = {};
		requiredVersion = 0.1;
...
class CfgVehicles
{
	...
	class TerritoryHQ: Container_Base
	{
		...
		hiddenSelectionsTextures[] = {"cfgrabbvppcompatible\Data\Images\Computer_OS_co.paa"};
	...
	class RA_BoxKit_Base: Container_Base
	{
		...
		hiddenSelectionsTextures[] = {"cfgrabbvppcompatible\Data\Images\carrierbox_apple_co.paa"};
	};
